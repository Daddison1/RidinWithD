...
export const metadata: Metadata = {
  ...
  description:
    "Curated dirt bike, e-bike, and riding gear deals. Filter by region and drive type.",
};
      ...
      <body className="min-h-screen bg-[var(--bg)] text-[var(--text)]">
        <header className="border-b border-white/10 bg-[var(--surface)]/80 backdrop-blur">
          <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4">
            ...
            <nav className="hidden items-center gap-6 text-sm md:flex">
              ...
              <Link className="text-[var(--accent)] hover:underline" href="/alerts">
                ❗Get Deal Email Alerts❗
              </Link>
              <Link
                className="text-white/80 hover:text-white hover:underline"
                href="/resources"
          ...
          <div className="border-t border-white/10 bg-black/40">
            <div className="mx-auto max-w-6xl px-4 py-2 text-sm text-white/85">
              <b className="text-[var(--accent)]">Best time to buy:</b> late fall
              + winter (off-season) and major holiday sales.{" "}
              <Link
          ...
          <div className="mx-auto max-w-6xl px-4 pb-4 md:hidden">
            <div className="flex flex-wrap gap-3 text-sm">
              <Link
                className="text-white/80 hover:text-white underline decoration-white/20"
                href="/"
              >
                Deals
              </Link>
              <Link className="text-[var(--accent)] underline" href="/alerts">
                Alerts
              </Link>
              <Link
                className="text-white/80 hover:text-white underline decoration-white/20"
        ...
        <footer className="mt-10 border-t border-white/10 bg-[var(--surface)]">
          <div className="mx-auto max-w-6xl px-4 py-8 text-sm text-white/70">
            ...
            <p className="mt-2">
              Purchases made through links on this site may earn a commission at
              no extra cost to you. Prices and availability can change quickly.
            </p>
